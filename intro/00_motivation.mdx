...
and you will master this techstack and workflow in no time
**
...
- a **database**, so you can save users
- **authentification**, so you can paywall your product
- **payments**, so they can pay for your product
- **emails**, so you can do marketing and communicate with users
...
both orchestrated Docker containers and serverless Lambda functions are supported.
...
Thats it! Throughout this documentation I am going to teach you and help you setup:
